      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">전체 사용자 {users.length}명</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-sm text-gray-600">학생</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-sm text-gray-600">학부모</h3>
            <p className="text-2xl font-bold text-gray-900">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-sm text-gray-600">교사</h3>
            <p className="text-2xl font-bold text-gray-900">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-sm text-gray-600">관리자</h3>
            <p className="text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-700">사용자</th>
                ...
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-700">추가 정보</th>
                <th className="px-6 py-3 text-left text-sm font-medium text-gray-700">등록일</th>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-gray-900">새 사용자 추가</h3>
                <button
