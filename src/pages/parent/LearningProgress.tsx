    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold text-gray-900">학습 현황</h2>
            <p className="text-gray-600 mt-1">{childData.name}의 상세 학습 분석</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <p className="text-2xl font-bold text-gray-900">48.5시간</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between mb-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm text-green-600">+3권</span>
            </div>
            <h3 className="text-sm text-gray-600">완료 콘텐츠</h3>
            <p className="text-2xl font-bold text-gray-900">42개</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between mb-2">
              <Award className="w-8 h-8 text-yellow-500" />
              <span className="text-sm text-green-600">+5개</span>
            </div>
            <h3 className="text-sm text-gray-600">획득 배지</h3>
            <p className="text-2xl font-bold text-gray-900">28개</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div key={subject.subject} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                      <span className="text-sm text-gray-500">목표: {subject.target}%</span>
                      <span className="font-bold text-gray-900">{subject.current}%</span>
                  ...
                  <div className="relative">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="absolute top-0 left-0 h-2 bg-gray-300 rounded-full" style={{ width: `${subject.target}%` }} />
                      <div className="absolute top-0 left-0 h-2 bg-blue-500 rounded-full" style={{ width: `${subject.current}%` }} />
                    </div>
                  </div>
                </div>
              ))}
          ...
          {/* 학습 시간 분석 */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-4">일일 학습시간 (계획 vs 실제)</h3>
        ...
        {/* 주간 학습 패턴 */}
        <div className="bg-white rounded-lg shadow-md p-6">
          <h3 className="text-lg font-bold text-gray-900 mb-4">주간 과목별 학습 패턴</h3>
